  ...
  async function handleSubmit() {
    ...
    try {
      ...
      try {
        ...
        setSubmitError('Server error — could not complete registration. Please ensure the server is running and try again.');
        setLoading(false);
        return;
      }

      if (!res.ok) {
        setSubmitError(data.error || 'Registration failed. Please check your details and try again.');
        setLoading(false);
        return;
      }
